<%@ Page Title="Mi Perfil" Language="C#" MasterPageFile="~/Cliente.Master" AutoEventWireup="true" CodeBehind="ClientePerfil.aspx.cs" Inherits="LocalWebService.ClientePerfil" %>
            ...
            <div class="col-md-6">
                <div class="perfil-card shadow">
                    ...
                    <div class="perfil-info">
                        ...
                        <asp:Label ID="lblNombreError" runat="server" CssClass="text-danger d-block" />
                    </div>
                    ...
                    <div class="perfil-info">
                        ...
                        <asp:Label ID="lblApPaternoError" runat="server" CssClass="text-danger d-block" />
                    </div>
                    ...
                    <div class="perfil-info">
                        ...
                        <asp:Label ID="lblApMaternoError" runat="server" CssClass="text-danger d-block" />
                    </div>
                    ...
                    <div class="perfil-info">
                        ...
                        <asp:Label ID="lblCorreoError" runat="server" CssClass="text-danger d-block" />
                    </div>
                    ...
                    <div class="perfil-info">
                        ...
                        <asp:Label ID="lblTelefonoError" runat="server" CssClass="text-danger d-block" />
                    </div>
