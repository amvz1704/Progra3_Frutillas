...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-center mt-4">
      ...
      <asp:Button ID="btnPagar" runat="server" Text="🛒 Pagar" CssClass="btn btn-success" OnClientClick ="javascript:var m=new bootstrap.Modal(document.getElementById('successModal'));m.show(); return false;" />
    </div>
